...
contract PointsHook is BaseHook, ERC20 {
    ...
    function afterSwap(
        ...
        // Token 0 is always ETH in a native pool
        // zeroForOne is true if user is swapping token 0 (ETH) for token 1 (TOKEN), i.e. selling ETH for TOKEN
        ...
        uint256 ethSpendAmount = swapParams.amountSpecified < 0
            ...
            : uint256(int256(-delta.amount0())); // amount0() function here comes from BalanceDeltaLibrary
