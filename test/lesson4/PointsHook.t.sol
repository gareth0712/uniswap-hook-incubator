...
contract TestPointsHook is Test, Deployers {
    ...
    function setUp() public {
        // 1) Deploy instance of PoolManager
        ...
        // 4) Mint a bunch of TOKEN to ourselves and to address(1)
        token.mint(address(this), 1000 ether);
        token.mint(address(1), 1000 ether);

        // 5) Mine an address that has flags set for the hook functions we want
    ...
    function test_addLiquidityAndSwap() public {
        ...
        // View the above comment section for how we derived the value of 0.003 ether
